...
sendBtn.addEventListener("click", () => {
    ...
    sendOrderToSheet(orderNumber, name, phone, governorate, city, address, plainOrderDetails, total);
...
function sendOrderToSheet(orderNumber, name, phone, governorate, city, address, orderDetails, total) {
